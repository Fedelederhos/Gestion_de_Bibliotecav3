...
namespace Gestion_de_Bibliotecav3.DAL.EntityFramework
{
    ...
    /// </summary>
    public class RepositorioUsuarios : Repository<Dominio.BusquedaUsuarioDTO, AdministradorPrestamosDBContext>, IRepositorioUsuarios
    {
        /// <summary>
        ...
        {
            List<BusquedaUsuarioDTO> usuarios = (List<BusquedaUsuarioDTO>)GetAll(); // Obtiene todos los usuarios de la base de datos.
            foreach (BusquedaUsuarioDTO usuario in usuarios)
            {
        ...
        {
            List<BusquedaUsuarioDTO> usuarios = (List<BusquedaUsuarioDTO>)GetAll(); // Obtiene todos los usuarios de la base de datos.
            BusquedaUsuarioDTO usuarioBuscado = new BusquedaUsuarioDTO(); // Inicializa un nuevo objeto Usuario para almacenar el usuario encontrado.
        ...
        {
            List<BusquedaUsuarioDTO> usuarios = (List<BusquedaUsuarioDTO>)GetAll(); // Obtiene todos los usuarios de la base de datos.
            List<BusquedaUsuarioDTO> usuarioBuscado = new List<BusquedaUsuarioDTO>(); // Inicializa una nueva lista para almacenar los usuarios encontrados.
